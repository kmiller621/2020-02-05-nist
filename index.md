...
address: "National Institute of Standards and Technology, Lecture Room B (the 5th)/A (the 12th), 100 Bureau Dr., Gaithersburg, MD  20899, USA"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "Feb 5th and 12th, 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Jon Guyer", "Justin Senseney"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
{% endcomment %}
{% if page.eventbrite %}
<strong>Register for the course here: <a href="https://psd.oism.nist.gov/2020-02-05-nist">https://psd.oism.nist.gov/2020-02-05-nist</a></strong>
{% endif %}
